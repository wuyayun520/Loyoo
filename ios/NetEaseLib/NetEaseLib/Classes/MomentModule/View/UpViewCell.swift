...
fileprivate let str_moreTimeData:[UInt8] = [0x69,0x6e,0x69,0x74,0x28,0x63,0x6f,0x64,0x65,0x72,0x3a,0x29,0x20,0x68,0x61,0x73,0x20,0x6e,0x6f,0x74,0x20,0x62,0x65,0x65,0x6e,0x20,0x69,0x6d,0x70,0x6c,0x65,0x6d,0x65,0x6e,0x74,0x65,0x64]

/*: "icon_chat_start" :*/
fileprivate let str_sizeVideoText:String = "packageon"
fileprivate let str_personMakeContent:String = "object else position content maket_star"
fileprivate let str_viewTitle:String = "random"

/*: "#752FE9" :*/
fileprivate let str_cellHeadValue:String = "#752FEcount list equal view"
fileprivate let str_colorData:String = "9"

/*: "#F5F5F5" :*/
fileprivate let str_liveName:[Character] = ["#","F","5","F","5","F","5"]

/*: "@ :*/
fileprivate let str_topData:[Character] = ["@"]

/*: "btn_feed_dianzan_nor" :*/
fileprivate let str_viewValue:[UInt8] = [0x62,0x74,0x6e,0x5f,0x66,0x65,0x65,0x64,0x5f,0x64,0x69,0x61,0x6e,0x7a,0x61,0x6e,0x5f,0x6e,0x6f,0x72]

/*: "btn_feed_reply_nor" :*/
fileprivate let str_norButtonPathName:String = "btn_custom raw"
fileprivate let str_mData:String = "price"
fileprivate let str_statusTitle:String = "REPLY"
...
class UpViewCell: UITableViewCell {
    var streetwiseImageView: UIImageView?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_moreTimeData, encoding: .utf8)!)
    }
    ...
    lazy var playView: UIImageView = {
        ...
        img.image = UIImage.outsideText(name: (str_sizeVideoText.replacingOccurrences(of: "package", with: "ic") + "_cha" + String(str_personMakeContent.suffix(6)) + str_viewTitle.replacingOccurrences(of: "random", with: "t")))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    private lazy var atNickNameLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(str_cellHeadValue.prefix(6)) + str_colorData.capitalized))
    ...
    private lazy var mainContentView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(str_liveName)))
...
extension UpViewCell {
    ...
    func notTable(_ model: CoequalListModel) {
        //: headImgView.setUrlImage(urlStr: model.headPic, placeImg: UIImage.placeSquareBigImgBanner())
        headImgView.posit(urlStr: model.headPic, placeImg: UIImage.project())
        ...
        previewImgView.recordFinish(urlStr: model.imageUrl)
        ...
        let typeImgStr = (model.type == 0) ? String(bytes: str_viewValue, encoding: .utf8)! : (String(str_norButtonPathName.prefix(4)) + "feed" + str_mData.replacingOccurrences(of: "price", with: "_") + str_statusTitle.lowercased() + "_nor")
        //: statusIcon.image = UIImage.outsideText(name: typeImgStr)
        statusIcon.image = UIImage.outsideText(name: typeImgStr)
...
extension UpViewCell {
    ...
    private func stroke() {
        ...
        nickNameLab.snp.makeConstraints { make in
            ...
            make.width.lessThanOrEqualTo((a_blockValue - 128) / 2)
        }
