...
/*: "title" :*/
fileprivate let str_toName:String = "tviewtle"

/*: "content" :*/
fileprivate let str_skinData:String = "ckey"
fileprivate let str_reduceValue:[Character] = ["n","t","e","n","t"]
...
/*: "img" :*/
fileprivate let str_equalData:[Character] = ["i","m","g"]

/*: "jumpKey" :*/
fileprivate let str_jumpSucceedName:String = "jumpKfollow string count to in"
fileprivate let str_textScriptName:String = "gifty"
...
@objcMembers public class SpringCellData: AppCellData {
    // 数据
    //: var extraJson: JSON {
    var extraJson: JSON {
    ...
    public lazy var titleAttrStr: NSMutableAttributedString = {
        ...
        let attributes = [.foregroundColor: UIColor.blockOf(), .font: UIFont.thoughtImage(type: .Medium, fontSize: 17)] as [NSAttributedString.Key: Any]
        //: let attributeStr = NSMutableAttributedString(string: extraJson["title"].stringValue)
        let attributeStr = NSMutableAttributedString(string: extraJson[(str_toName.replacingOccurrences(of: "view", with: "i"))].stringValue)
    ...
    public lazy var contentAttrStr: NSMutableAttributedString = {
        ...
        let attributes = [.foregroundColor: UIColor.complexion(), .font: UIFont.thoughtImage(type: .Regular, fontSize: 14)] as [NSAttributedString.Key: Any]
        //: let attributeStr = NSMutableAttributedString(string: extraJson["content"].stringValue)
        let attributeStr = NSMutableAttributedString(string: extraJson[(str_skinData.replacingOccurrences(of: "key", with: "o") + String(str_reduceValue))].stringValue)
        //: attributeStr.addAttributes(attributes, range: NSRange(location: 0, length: attributeStr.length))
        attributeStr.addAttributes(attributes, range: NSRange(location: 0, length: attributeStr.length))
        //: return attributeStr
        return attributeStr
    ...
    override public func height(ofWidth _: CGFloat) -> CGFloat {
        ...
        if extraJson[(String(str_equalData))].stringValue.count > 0 {
        ...
        if extraJson[(str_toName.replacingOccurrences(of: "view", with: "i"))].stringValue.count > 0 {
        ...
        if extraJson[(str_skinData.replacingOccurrences(of: "key", with: "o") + String(str_reduceValue))].stringValue.count > 0 {
            //: height += 4
            height += 4
        ...
        if extraJson[(String(str_jumpSucceedName.prefix(5)) + str_textScriptName.replacingOccurrences(of: "gift", with: "e"))].stringValue.count > 0 {
            //: jumpHeight = 35
            jumpHeight = 35
            //: height += jumpHeight
            height += jumpHeight
