...
fileprivate let str_contentPathData:[UInt8] = [0x69,0x6e,0x69,0x74,0x28,0x63,0x6f,0x64,0x65,0x72,0x3a,0x29,0x20,0x68,0x61,0x73,0x20,0x6e,0x6f,0x74,0x20,0x62,0x65,0x65,0x6e,0x20,0x69,0x6d,0x70,0x6c,0x65,0x6d,0x65,0x6e,0x74,0x65,0x64]
...
// __CLOSE_PRINT__
//
//  HypsometryReactiveCompatible.swift
//  AbroadTalking
//
...
class HypsometryReactiveCompatible: UIView {
    var disagreeImageView: UIImageView?
    //: class func create(_ frame: CGRect) -> UIView {
    class func playerInSave(_ frame: CGRect) -> UIView {
        //: return MAScreenShieldView(frame: frame)
        return HypsometryReactiveCompatible(frame: frame)
    }
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_contentPathData, encoding: .utf8)!)
    }
...
extension HypsometryReactiveCompatible {
