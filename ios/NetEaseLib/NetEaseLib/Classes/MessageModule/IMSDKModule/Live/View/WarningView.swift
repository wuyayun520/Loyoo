...
fileprivate let str_labTitle:[UInt8] = [0x69,0x6e,0x69,0x74,0x28,0x63,0x6f,0x64,0x65,0x72,0x3a,0x29,0x20,0x68,0x61,0x73,0x20,0x6e,0x6f,0x74,0x20,0x62,0x65,0x65,0x6e,0x20,0x69,0x6d,0x70,0x6c,0x65,0x6d,0x65,0x6e,0x74,0x65,0x64]

/*: "icon_tc_warn" :*/
fileprivate let str_makeContent:String = "key"
fileprivate let str_styleValue:[Character] = ["c","o","n","_","t","c","_","w","a","r","n"]

/*: "Live Warning" :*/
fileprivate let str_momentName:String = "model type equalLive W"

/*: "OK" :*/
fileprivate let str_toText:[Character] = ["O","K"]

/*: "Violation Reason: " :*/
fileprivate let str_buttonValue:String = "to manager sizeViol"
fileprivate let str_singleValue:String = "ason: height self type mini"

/*: "Warning Time: " :*/
fileprivate let str_makeData:String = "screen withWarning "
fileprivate let str_selectFirstValue:String = "let var makeTime: "
...
class WarningView: UIView {
    var nameScreenImageView: UIImageView?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_labTitle, encoding: .utf8)!)
    }
    ...
    private lazy var topIcon: UIImageView = {
        ...
        let iamg = UIImageView()
        //: iamg.image = UIImage.outsideText(name: "icon_tc_warn")
        iamg.image = UIImage.outsideText(name: (str_makeContent.replacingOccurrences(of: "key", with: "i") + String(str_styleValue)))
    ...
    private lazy var titleLab: UILabel = {
        ...
        lab.text = (String(str_momentName.suffix(6)) + "arning").localized
        //: return lab
        return lab
        //: }()
    }()
    ...
    private lazy var okBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(smartDismiss), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
...
extension WarningView {
    ...
    func holograph(content: String, reason: String, time: String) {
        //: contentLab.text = content
        contentLab.text = content

        //: let attributes = [.foregroundColor: UIColor.appThemeColor()] as [NSAttributedString.Key: Any]
        let attributes = [.foregroundColor: UIColor.offt()] as [NSAttributedString.Key: Any]
        //: var reasonText = "Violation Reason: ".localized
        var reasonText = (String(str_buttonValue.suffix(4)) + "ation Re" + String(str_singleValue.prefix(6))).localized
        ...
        var timeText = (String(str_makeData.suffix(8)) + String(str_selectFirstValue.suffix(6))).localized
