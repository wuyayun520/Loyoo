...
fileprivate let str_toText:[UInt8] = [0x65,0x62,0x65,0x78,0x24,0x6f,0x63,0x68,0x69,0x7e,0x36,0x25,0x2c,0x64,0x6d,0x7f,0x2c,0x62,0x63,0x78,0x2c,0x6e,0x69,0x69,0x62,0x2c,0x65,0x61,0x7c,0x60,0x69,0x61,0x69,0x62,0x78,0x69,0x68]

/*: "Enter phone number" :*/
fileprivate let str_requestValue:String = "var time interactionEnte"
fileprivate let str_topValue:String = "one numbmake view holder new point"
fileprivate let str_viewValueData:[Character] = ["e","r"]

/*: "Enter Email Address" :*/
fileprivate let str_scaleValue:[Character] = ["E","n","t","e","r"," ","E","m","a","i","l"]
fileprivate let str_conversationContent:[Character] = [" ","A","d","d","r","e","s","s"]

/*: "F4F4F4" :*/
fileprivate let str_pushContent:String = "FmanagerFmanagerFmanager"

/*: "America(+1)" :*/
fileprivate let str_equalToolData:[Character] = ["A","m","e","r","i","c","a","("]
fileprivate let str_specialName:String = "+video)"

/*: "area_code_down_icon" :*/
fileprivate let str_failText:String = "height as count in managerarea_"
fileprivate let str_visiblePhotoData:String = "down_ishared let var data"
fileprivate let str_colorBackgroundData:String = "coparty"

/*: "BBBBBB" :*/
fileprivate let str_requestText:String = "actionactionaction"

/*: "btn_field_delete_icon" :*/
fileprivate let str_iconData:[Character] = ["b","t","n","_","f","i","e","l","d","_","d","e","l","e"]
fileprivate let str_transactionTitle:String = "tresult"
fileprivate let str_labelLimitValue:String = "context icon object self bottom_icon"

/*: "Password" :*/
fileprivate let str_colorName:[Character] = ["P","a","s","s","w","o","r","d"]

/*: "CCCCCC" :*/
fileprivate let str_gameTouchData:String = "value"
fileprivate let str_shareText:String = "modelmodelC"

/*: "or" :*/
fileprivate let str_aspectName:String = "managerr"

/*: "F5F5F5" :*/
fileprivate let str_makeMainValue:[Character] = ["F","5","F","5","F","5"]

/*: "Next" :*/
fileprivate let str_viewName:[Character] = ["N","e","x","t"]

/*: "Login by password" :*/
fileprivate let str_itemValue:[Character] = ["L","o","g","i","n"," ","b","y"," ","p","a","s","s","w","o","r","d"]

/*: "Login by OTP" :*/
fileprivate let str_appearMakeValue:String = "color to hiddenLogi"
fileprivate let str_mediumTitle:String = "OviewP"

/*: "#8C7AFF" :*/
fileprivate let str_constraintFinishReturnTitle:String = "#8C7AFFshared var"

/*: "Login" :*/
fileprivate let str_fillName:String = "Loginedit time action source"

/*: "Send verification" :*/
fileprivate let str_countData:[Character] = ["S","e","n","d"," ","v"]
fileprivate let str_textTitle:String = "eimagefi"
...
class NameFieldDelegate: UIView, UITextFieldDelegate {
    var dismissQuantityimateImageView: UIImageView?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_toText.map{$0^12}, encoding: .utf8)!)
    }
    ...
    private lazy var titleLabel: UILabel = {
        ...
        label.text = self.loginType == .LoginPhone ? (String(str_requestValue.suffix(4)) + "r ph" + String(str_topValue.prefix(8)) + String(str_viewValueData)).localized : (String(str_scaleValue) + String(str_conversationContent)).localized
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaCodeControl: UIControl = {
        ...
        control.backgroundColor = UIColor(hex: (str_pushContent.replacingOccurrences(of: "manager", with: "4")))
    ...
    lazy var areaCodeLabel: UILabel = {
        ...
        label.text = (String(str_equalToolData) + str_specialName.replacingOccurrences(of: "video", with: "1"))
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var areaDownImgView: UIImageView = {
        ...
        imageView.image = UIImage.outsideText(name: (String(str_failText.suffix(5)) + "code_" + String(str_visiblePhotoData.prefix(6)) + str_colorBackgroundData.replacingOccurrences(of: "party", with: "n")))
        //: return imageView
        return imageView
        //: }()
    }()
    ...
    private lazy var phoneInputView: UITextField = {
        ...
        textField.backgroundColor = UIColor(hex: (str_pushContent.replacingOccurrences(of: "manager", with: "4")))
        //: textField.font = .pingfangFont(type: .Medium, fontSize: 17)
        textField.font = .thoughtImage(type: .Medium, fontSize: 17)
        ...
        textField.attributedPlaceholder = NSAttributedString(string: "", attributes: [NSAttributedString.Key.font: UIFont.thoughtImage(type: .Regular, fontSize: 17), NSAttributedString.Key.foregroundColor: UIColor(hex: (str_requestText.replacingOccurrences(of: "action", with: "BB")))!])
    ...
    private lazy var phoneDeleteBtn: UIButton = {
        ...
        btn.setImage(UIImage.outsideText(name: (String(str_iconData) + str_transactionTitle.replacingOccurrences(of: "result", with: "e") + String(str_labelLimitValue.suffix(5)))), for: .normal)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var pwdTitleLab: UILabel = {
        ...
        lab.text = (String(str_colorName)).localized
    ...
    lazy var otherLabel: UILabel = {
        ...
        label.textColor = UIColor(hex: (str_gameTouchData.replacingOccurrences(of: "value", with: "C") + str_shareText.replacingOccurrences(of: "model", with: "CC")))
    ...
    lazy var otherLeftLine: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(str_makeMainValue)))
        //: return view
        return view
        //: }()
    }()
    ...
    lazy var commitButton: UIButton = {
        ...
        btn.setTitle((String(str_viewName)).localized, for: .normal)
    ...
    private lazy var loginStyleBtn: UIButton = {
        ...
        btn.setTitleColor(UIColor.offt(), for: .selected)
        //: btn.setTitle("Login by password".localized, for: .normal)
        btn.setTitle((String(str_itemValue)).localized, for: .normal)
        //: btn.setTitle("Login by OTP".localized, for: .selected)
        btn.setTitle((String(str_appearMakeValue.suffix(4)) + "n by " + str_mediumTitle.replacingOccurrences(of: "view", with: "T")).localized, for: .selected)
        //: btn.addTarget(self, action: #selector(loginStyleButtonClick(sender:)), for: .touchUpInside)
        btn.addTarget(self, action: #selector(medium(sender:)), for: .touchUpInside)
        //: btn.layer.cornerRadius = 25
        btn.layer.cornerRadius = 25
        //: btn.layer.borderWidth = 2
        btn.layer.borderWidth = 2
        //: btn.layer.borderColor = UIColor(hex: "#8C7AFF")?.withAlphaComponent(0.6).cgColor
        btn.layer.borderColor = UIColor(hex: (String(str_constraintFinishReturnTitle.prefix(7))))?.withAlphaComponent(0.6).cgColor
        //: return btn
        return btn
        //: }()
    }()
...
extension NameFieldDelegate {
    ...
    @objc private func medium(sender: UIButton) {
        ...
        if sender.isSelected == true { // pwd
            ...
            commitButton.setTitle((String(str_fillName.prefix(5))).localized, for: .normal)
            //: } else {
        } else { // OTP
            //: commitButton.setTitle("Next".localized, for: .normal)
            commitButton.setTitle((String(str_viewName)).localized, for: .normal)
        }
    ...
    func resignSize() {
        ...
        commitButton.setTitle((String(str_countData) + str_textTitle.replacingOccurrences(of: "image", with: "ri") + "cation").localized, for: .normal)
    }
}
