...
fileprivate let str_curData:[UInt8] = [0x69,0x6e,0x69,0x74,0x28,0x63,0x6f,0x64,0x65,0x72,0x3a,0x29,0x20,0x68,0x61,0x73,0x20,0x6e,0x6f,0x74,0x20,0x62,0x65,0x65,0x6e,0x20,0x69,0x6d,0x70,0x6c,0x65,0x6d,0x65,0x6e,0x74,0x65,0x64]

/*: "icon_rank_coin" :*/
fileprivate let str_listText:[UInt8] = [0x6e,0x69,0x6f,0x63,0x5f,0x6b,0x6e,0x61,0x72,0x5f,0x6e,0x6f,0x63,0x69]

/*: "icon_lounge" :*/
fileprivate let str_nameCenterText:[Character] = ["i","c","o","n","_","l","o","u"]
fileprivate let str_beginData:[Character] = ["n","g","e"]

/*: "icon_rank_coin2" :*/
fileprivate let str_makeData:String = "layer size hiddenicon_"
fileprivate let str_countData:String = "OIN2"
...
class ConstraintViewCell: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_curData, encoding: .utf8)!)
    }
    ...
    lazy var rankLabel = UILabel().then {
        ...
        $0.textColor = UIColor.observerShared()
        //: $0.font = .pingfangFont(type: .Semibold, fontSize: 20)
        $0.font = .thoughtImage(type: .Semibold, fontSize: 20)
    }
    ...
    lazy var coinIconBtn = PathErrorTalkingButton().then {
        //: $0.setImage(UIImage.outsideText(name: "icon_rank_coin"), for: .normal)
        $0.setImage(UIImage.outsideText(name: String(bytes: str_listText.reversed(), encoding: .utf8)!), for: .normal)
        //: $0.setTitleColor(UIColor.white, for: .normal)
        $0.setTitleColor(UIColor.white, for: .normal)
        //: $0.titleLabel?.font = .pingfangFont(type: .Medium, fontSize: 15)
        $0.titleLabel?.font = .thoughtImage(type: .Medium, fontSize: 15)
        ...
        $0.setBackgroundImage(UIImage.stopAcross(colors: UIColor.doRange(), size: CGSize(width: actualWidth(w: 80), height: actualWidth(w: 33))), for: .normal)
    ...
    lazy var loungeImgV = UIImageView().then {
        ...
        $0.image = UIImage.outsideText(name: (String(str_nameCenterText) + String(str_beginData)))
    }
}
...
extension ConstraintViewCell {
    //: func updateRankCell(model: SocialRankItemModel, index: Int) {
    func searchPlaceIndex(model: DoingItemModel, index: Int) {
        ...
        headPic.recordFinish(urlStr: model.headPic)
    ...
    func iconTitle(type: Int) {
        //: let imageStr = type == 0 ? "icon_rank_coin":"icon_rank_coin2"
        let imageStr = type == 0 ? String(bytes: str_listText.reversed(), encoding: .utf8)! : (String(str_makeData.suffix(5)) + "rank_c" + str_countData.lowercased())
        //: coinIconBtn.setImage(UIImage.outsideText(name: imageStr), for: .normal)
        coinIconBtn.setImage(UIImage.outsideText(name: imageStr), for: .normal)
    }
}
