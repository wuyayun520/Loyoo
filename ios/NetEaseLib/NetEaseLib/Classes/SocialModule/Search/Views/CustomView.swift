...
fileprivate let str_makeData:[UInt8] = [0xc5,0xc2,0xc5,0xd8,0x84,0xcf,0xc3,0xc8,0xc9,0xde,0x96,0x85,0x8c,0xc4,0xcd,0xdf,0x8c,0xc2,0xc3,0xd8,0x8c,0xce,0xc9,0xc9,0xc2,0x8c,0xc5,0xc1,0xdc,0xc0,0xc9,0xc1,0xc9,0xc2,0xd8,0xc9,0xc8]

/*: "icon_lounge" :*/
fileprivate let str_messageTitle:String = "ibodyon"
fileprivate let str_buttonValue:[Character] = ["_","l","o","u","n","g","e"]

/*: "#777777" :*/
fileprivate let str_youValue:[Character] = ["#","7","7","7","7","7"]
fileprivate let str_byName:String = "shared"

/*: "UID: :*/
fileprivate let str_colorVoiceData:String = "self view view seaUID:"
...
class CustomView: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        characteristicRootOfASquareMatrix()
    }

    //: required init?(coder: NSCoder) {
    required init?(coder _: NSCoder) {
        //: fatalError("init(coder:) has not been implemented")
        fatalError(String(bytes: str_makeData.map{$0^172}, encoding: .utf8)!)
    }
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.outsideText(name: (str_messageTitle.replacingOccurrences(of: "body", with: "c") + String(str_buttonValue)))
        //: return img
        return img
        //: }()
    }()
    ...
    private lazy var desLab: UILabel = {
        ...
        lab.textColor = UIColor(hex: (String(str_youValue) + str_byName.replacingOccurrences(of: "shared", with: "7")))
        //: return lab
        return lab
        //: }()
    }()
...
extension CustomView {
    ...
    func fillDownMonth(model: GoldTransformable) {
        //: headPicImgV.setUrlImage(urlStr: model.headPic)
        headPicImgV.recordFinish(urlStr: model.headPic)
        //: nicknameLab.textColor = model.loungePlus ? .userVipColor():.appTitleColor()
        nicknameLab.textColor = model.loungePlus ? .withTime() : .blockOf()
        //: nicknameLab.text = model.nickname
        nicknameLab.text = model.nickname
        //: uidLab.text = "UID:\(model.uid)"
        uidLab.text = (String(str_colorVoiceData.suffix(4))) + "\(model.uid)"
...
extension CustomView {
    ...
    private func characteristicRootOfASquareMatrix() {
