...
/*: "btn_me_edit" :*/
fileprivate let str_tagValue:String = "for equal true mode selfbtn_m"
...
class LoadReactiveCompatible: UITableViewCell {
    ...
    private lazy var rightImgV: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.outsideText(name: (String(str_tagValue.suffix(5)) + "e_edit")))
        //: return imag
        return imag
        //: }()
    }()
...
extension LoadReactiveCompatible {
    ...
    func nog(title: String, value: String) {
        //: titleLab.text = title
        titleLab.text = title
        //: valueLab.text = value
        valueLab.text = value
