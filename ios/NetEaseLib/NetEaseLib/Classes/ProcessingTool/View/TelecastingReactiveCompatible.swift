...
fileprivate let str_onValue:[UInt8] = [0x69,0x6e,0x69,0x74,0x28,0x63,0x6f,0x64,0x65,0x72,0x3a,0x29,0x20,0x68,0x61,0x73,0x20,0x6e,0x6f,0x74,0x20,0x62,0x65,0x65,0x6e,0x20,0x69,0x6d,0x70,0x6c,0x65,0x6d,0x65,0x6e,0x74,0x65,0x64]

/*: "Add" :*/
fileprivate let str_minValue:[Character] = ["A","d","d"]

/*: "btn_me_edit" :*/
fileprivate let str_thirdData:[Character] = ["b","t","n","_","m","e","_","e","d","i","t"]

/*: "Program" :*/
fileprivate let str_toTextValue:[Character] = ["P","r","o","g","r","a","m"]
...
// __CLOSE_PRINT__
//
//  TelecastingReactiveCompatible.swift
//  AbroadTalking
//
...
class TelecastingReactiveCompatible: UITableViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_onValue, encoding: .utf8)!)
    }
    ...
    private lazy var backBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(trackPosition), for: .touchUpInside)
        //: return btn
        return btn
        //: }()
    }()
    ...
    private lazy var tipsLab: UILabel = {
        ...
        lb.text = (String(str_minValue)).localized
        //: return lb
        return lb
        //: }()
    }()
    ...
    private lazy var editImg: UIImageView = {
        ...
        let imag = UIImageView(image: UIImage.outsideText(name: (String(str_thirdData))))
        //: imag.isUserInteractionEnabled = false
        imag.isUserInteractionEnabled = false
        //: return imag
        return imag
...
extension TelecastingReactiveCompatible {
    //: func setViewData(title: String, icon: String) {
    func colored(title: String, icon: String) {
        //: iconImg.image = UIImage.outsideText(name: icon)
        iconImg.image = UIImage.outsideText(name: icon)
        //: titleLab.text = title.localized
        titleLab.text = title.localized
        //: if title == "Program" {
        if title == (String(str_toTextValue)) {
    ...
    func style() {
        ...
        backBtn.barRadii(width: a_blockValue - 30, height: 50, corners: [.topLeft, .topRight], cornerRadii: .init(width: 8, height: 8))
    }
}
