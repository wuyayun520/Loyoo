...
fileprivate let str_indexSearchedData:[UInt8] = [0x69,0x6e,0x69,0x74,0x28,0x63,0x6f,0x64,0x65,0x72,0x3a,0x29,0x20,0x68,0x61,0x73,0x20,0x6e,0x6f,0x74,0x20,0x62,0x65,0x65,0x6e,0x20,0x69,0x6d,0x70,0x6c,0x65,0x6d,0x65,0x6e,0x74,0x65,0x64]

/*: "icon_lounge" :*/
fileprivate let str_sizeFrameReturnData:[Character] = ["i","c","o","n","_"]
fileprivate let str_colorName:[Character] = ["l","o","u","n","g","e"]

/*: "icon_home_v" :*/
fileprivate let str_liveName:[Character] = ["i","c","o","n","_","h"]
fileprivate let str_videoValue:[Character] = ["o","m","e","_","v"]

/*: "My album" :*/
fileprivate let str_labText:String = "report message arrayMy albu"
fileprivate let str_roomValue:String = "make"

/*: "0A071F" :*/
fileprivate let str_stackName:[Character] = ["0"]
fileprivate let str_targetValue:[Character] = ["A","0","7","1","F"]

/*: "#C5BEFF" :*/
fileprivate let str_userName:[Character] = ["#","C","5","B","E","F","F"]

/*: "🎉congratulations! She may be very interested in you. She's not far from you. \nWhy don't you say hello to her?" :*/
fileprivate let str_pageTitleName:[UInt8] = [0xf0,0x9f,0x8e,0x89,0x63,0x6f,0x6e,0x67,0x72,0x61,0x74,0x75,0x6c,0x61,0x74,0x69,0x6f,0x6e,0x73,0x21,0x20,0x53,0x68,0x65,0x20,0x6d,0x61,0x79,0x20,0x62,0x65,0x20,0x76,0x65,0x72,0x79,0x20,0x69,0x6e,0x74,0x65,0x72,0x65,0x73,0x74,0x65,0x64,0x20,0x69,0x6e,0x20,0x79,0x6f,0x75,0x2e,0x20,0x53,0x68,0x65,0x27,0x73,0x20,0x6e,0x6f,0x74,0x20,0x66,0x61,0x72,0x20,0x66,0x72,0x6f,0x6d,0x20,0x79,0x6f,0x75,0x2e,0x20,0xa,0x57,0x68,0x79,0x20,0x64,0x6f,0x6e,0x27,0x74,0x20,0x79,0x6f,0x75,0x20,0x73,0x61,0x79,0x20,0x68,0x65,0x6c,0x6c,0x6f,0x20,0x74,0x6f,0x20,0x68,0x65,0x72,0x3f]

/*: "Why don't you say hello to her?" :*/
fileprivate let str_normalAddName:[UInt8] = [0x57,0x68,0x79,0x20,0x64,0x6f,0x6e,0x27,0x74,0x20,0x79,0x6f,0x75,0x20,0x73,0x61,0x79,0x20,0x68,0x65,0x6c,0x6c,0x6f,0x20,0x74,0x6f,0x20,0x68,0x65,0x72,0x3f]

/*: "🎉congratulations! He may be very interested in you. He's not far from you. \nWhy don't you say hello to him?" :*/
fileprivate let str_inviteValue:[UInt8] = [0x3f,0x6d,0x69,0x68,0x20,0x6f,0x74,0x20,0x6f,0x6c,0x6c,0x65,0x68,0x20,0x79,0x61,0x73,0x20,0x75,0x6f,0x79,0x20,0x74,0x27,0x6e,0x6f,0x64,0x20,0x79,0x68,0x57,0xa,0x20,0x2e,0x75,0x6f,0x79,0x20,0x6d,0x6f,0x72,0x66,0x20,0x72,0x61,0x66,0x20,0x74,0x6f,0x6e,0x20,0x73,0x27,0x65,0x48,0x20,0x2e,0x75,0x6f,0x79,0x20,0x6e,0x69,0x20,0x64,0x65,0x74,0x73,0x65,0x72,0x65,0x74,0x6e,0x69,0x20,0x79,0x72,0x65,0x76,0x20,0x65,0x62,0x20,0x79,0x61,0x6d,0x20,0x65,0x48,0x20,0x21,0x73,0x6e,0x6f,0x69,0x74,0x61,0x6c,0x75,0x74,0x61,0x72,0x67,0x6e,0x6f,0x63,0x89,0x8e,0x9f,0xf0]

/*: "Why don't you say hello to him?" :*/
fileprivate let str_mainTitle:[UInt8] = [0x57,0x68,0x79,0x20,0x64,0x6f,0x6e,0x27,0x74,0x20,0x79,0x6f,0x75,0x20,0x73,0x61,0x79,0x20,0x68,0x65,0x6c,0x6c,0x6f,0x20,0x74,0x6f,0x20,0x68,0x69,0x6d,0x3f]

/*: "#FFD13A" :*/
fileprivate let str_locationValue:String = "view to image error self#FFD13A"

/*: "icon_male_default" :*/
fileprivate let str_addData:[UInt8] = [0xd5,0xdf,0xd3,0xd2,0xe3,0xd1,0xdd,0xd0,0xd9,0xe3,0xd8,0xd9,0xda,0xdd,0xc9,0xd0,0xc8]

/*: "icon_female_default" :*/
fileprivate let str_giftName:String = "icon_femelse time"
fileprivate let str_requestTitle:String = "ale_dvar let"

/*: "   " :*/
fileprivate let str_withData:String = "   "

/*: "My interests：" :*/
fileprivate let str_genderName:[Character] = ["M"]
fileprivate let str_makeSearchedValue:[Character] = ["y"," ","i","n","t","e","r","e","s","t","s","："]

/*: "btn_me_edit" :*/
fileprivate let str_addBlockName:String = "self female namebtn_"
fileprivate let str_voicePlaceValue:String = "titlet"
...
class ActualReactiveCompatible: ComparableViewCell {
    var dataTargetImageView: UIImageView?

    //: var matchData: TalkingChatMatchMsgCellData?
    var matchData: ConcordCellData?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_indexSearchedData, encoding: .utf8)!)
    }
    ...
    private lazy var infoNameLab: UILabel = {
        ...
        label.font = UIFont.methodPlay(fontSize: 18)
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var loungeImgV: UIImageView = {
        ...
        img.image = UIImage.outsideText(name: (String(str_sizeFrameReturnData) + String(str_colorName)))
        //: img.isHidden = true
        img.isHidden = true
        //: return img
        return img
    ...
    private lazy var authImgview: UIImageView = {
        //: let imgV = UIImageView()
        let imgV = UIImageView()
        //: imgV.image = UIImage.outsideText(name: "icon_home_v")
        imgV.image = UIImage.outsideText(name: (String(str_liveName) + String(str_videoValue)))
        //: return imgV
        return imgV
        //: }()
    }()
    ...
    private lazy var imgTitleLab: UILabel = {
        ...
        label.font = UIFont.methodPlay(fontSize: 15)
        //: label.textColor = UIColor.appTitleColor()
        label.textColor = UIColor.blockOf()
        //: label.text = "My album".localized
        label.text = (String(str_labText.suffix(7)) + str_roomValue.replacingOccurrences(of: "make", with: "m")).localized
        //: return label
        return label
        //: }()
    }()
    ...
    private lazy var bgView: UIView = {
        ...
        view.backgroundColor = UIColor(hex: (String(str_stackName) + String(str_targetValue)))?.withAlphaComponent(0.3)
        //: view.layer.cornerRadius = 12
        view.layer.cornerRadius = 12
        //: view.layer.masksToBounds = true
        view.layer.masksToBounds = true
        ...
        view.layer.borderColor = UIColor(hex: (String(str_userName)))?.cgColor
        //: return view
        return view
        //: }()
    }()
    ...
    private lazy var matchLab: UILabel = {
        ...
        var str = String(bytes: str_pageTitleName, encoding: .utf8)!.localized
        //: var matchStr = "Why don't you say hello to her?".localized
        var matchStr = String(bytes: str_normalAddName, encoding: .utf8)!.localized

        //: if MeasurementAppManager.share.loginUserMode.sex == "2" {
        if MeasurementAppManager.share.loginUserMode.sex == "2" {
            //: str = "🎉congratulations! He may be very interested in you. He's not far from you. \nWhy don't you say hello to him?".localized
            str = String(bytes: str_inviteValue.reversed(), encoding: .utf8)!.localized
            //: matchStr = "Why don't you say hello to him?".localized
            matchStr = String(bytes: str_mainTitle, encoding: .utf8)!.localized
        }
        ...
        var attriString = NSMutableAttributedString(string: str as String, attributes: [.font: UIFont.methodPlay(fontSize: 15), .foregroundColor: UIColor.white])
        ...
        if let range = str.range(of: matchStr) {
            ...
            attriString.addAttributes([NSAttributedString.Key.foregroundColor: UIColor(hex: (String(str_locationValue.suffix(7))))!], range: nsRange)
        }
...
extension ActualReactiveCompatible {
    ...
    override func fill(with data: TCommonCellData) {
        ...
        self.matchData = data as? ConcordCellData
        ...
        // 为空时必须初始化
        //: let userInfoModel = self.matchData?.msgModel.userInfoModel ?? CountMediumCacheModel.init()
        let userInfoModel = self.matchData?.msgModel.userInfoModel ?? CountMediumCacheModel()
        ...
        if self.vipBgView.isHidden == false {
            //: if let vipModel = MeasurementAppManager.share.appUserConfigMode.vipSetting.filter({$0.vipSkinId == userInfoModel.vipSkinId}).first {

            if let vipModel = MeasurementAppManager.share.appUserConfigMode.vipSetting.filter({ $0.vipSkinId == userInfoModel.vipSkinId }).first {
                //: self.vipBgView.setUrlImage(urlStr: vipModel.vipChatSkin, placeImg: nil)
                self.vipBgView.recordFinish(urlStr: vipModel.vipChatSkin, placeImg: nil)
            }
        }
        //: self.headImgView.setUrlImage(urlStr: userInfoModel.headPic)
        self.headImgView.recordFinish(urlStr: userInfoModel.headPic)
        //: self.infoNameLab.textColor = userInfoModel.loungePlus ? .userVipColor():.appTitleColor()
        self.infoNameLab.textColor = userInfoModel.loungePlus ? .withTime() : .blockOf()
        ...
        let imgStr = userInfoModel.sex == SizeCustomReflectable.male.rawValue ? String(bytes: str_addData.map{$0^188}, encoding: .utf8)! : (String(str_giftName.prefix(8)) + String(str_requestTitle.prefix(5)) + "efault")
        //: sexBtn.setBackgroundImage(UIImage.outsideText(name: imgStr), for: .normal)
        sexBtn.setBackgroundImage(UIImage.outsideText(name: imgStr), for: .normal)
        ...
        if userInfoModel.interest.count > 0 {
            ...
            let matchStr = (String(str_genderName) + String(str_makeSearchedValue)).localized
            ...
            let attributes = [.font: UIFont.methodPlay(fontSize: 15), .foregroundColor: UIColor.offt()] as [NSAttributedString.Key: Any]
            ...
            attrString.addAttributes([NSAttributedString.Key.foregroundColor: UIColor.blockOf()], range: str.range(of: matchStr))
    ...
    func viewPath() {
        ...
        let maxCount = Int((a_blockValue - 60) / 62)
        ...
        for index in 0 ..< min(maxCount, matchData.msgModel.userInfoModel.picture.count) {
            ...
            imgV.recordFinish(urlStr: matchData.msgModel.userInfoModel.picture[index])
        ...
        if matchData.msgModel.userInfoModel.picture.count > maxCount {
            //: let imgV = UIImageView()
            let imgV = UIImageView()
            //: imgV.image = UIImage.outsideText(name: "btn_me_edit")
            imgV.image = UIImage.outsideText(name: (String(str_addBlockName.suffix(4)) + "me_e" + str_voicePlaceValue.replacingOccurrences(of: "title", with: "di")))
            //: self.pictureView.addSubview(imgV)
            self.pictureView.addSubview(imgV)
            //: imgV.snp.remakeConstraints { make in
            imgV.snp.remakeConstraints { make in
    ...
    override public func updateConstraints() {
        ...
        if userInfoModel.uid.isEmptyString {
            ...
            self.infoView.snp.remakeConstraints { make in
                ...
                make.width.equalTo(a_blockValue - 30)
            ...
            if userInfoModel.interest.count > 0 {
                ...
                let inTheight = self.interestsLab.sizeThatFits(CGSize(width: a_blockValue - 54, height: CGFLOAT_MAX)).height
                ...
                self.interestsLab.snp.remakeConstraints { make in
                    ...
                    make.width.equalTo(a_blockValue - 54)
        ...
        let labelSize = self.matchLab.sizeThatFits(CGSize(width: a_blockValue - 30 - 24, height: CGFLOAT_MAX))
...
extension ActualReactiveCompatible {
    ...
    private func aboveUp() {
        ...
        let tapGes = UITapGestureRecognizer(target: self, action: #selector(postPointCell(_:)))
    ...
    @objc func postPointCell(_: UITapGestureRecognizer) {
