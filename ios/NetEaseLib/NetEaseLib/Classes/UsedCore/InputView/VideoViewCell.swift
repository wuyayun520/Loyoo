...
fileprivate let str_collectionValue:[UInt8] = [0x69,0x6e,0x69,0x74,0x28,0x63,0x6f,0x64,0x65,0x72,0x3a,0x29,0x20,0x68,0x61,0x73,0x20,0x6e,0x6f,0x74,0x20,0x62,0x65,0x65,0x6e,0x20,0x69,0x6d,0x70,0x6c,0x65,0x6d,0x65,0x6e,0x74,0x65,0x64]

/*: "icon_coinxxx" :*/
fileprivate let str_arrayName:[Character] = ["i","c","o","n","_"]
fileprivate let str_giftData:String = "coinmodelx"

/*: "icon_gift_num_bg" :*/
fileprivate let str_scaleName:[Character] = ["i","c","o","n","_","g","i","f","t","_","n","u","m","_","b","g"]

/*: "x1" :*/
fileprivate let str_saveValue:String = "xwhite"

/*: " x :*/
fileprivate let str_adminTitle:[Character] = [" ","x"]
...
class VideoViewCell: UICollectionViewCell {
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_collectionValue, encoding: .utf8)!)
    }
    ...
    lazy var nameLB: UILabel = {
        ...
        lb.font = UIFont.thoughtImage(type: .Regular, fontSize: 10)
        //: lb.textColor = .white
        lb.textColor = .white
    ...
    lazy var priceBtn: PathErrorTalkingButton = {
        //: let btn = TalkingButton.init()
        let btn = PathErrorTalkingButton()
        //: btn.setTitleColor(UIColor.white, for: .normal)
        btn.setTitleColor(UIColor.white, for: .normal)
        //: btn.titleLabel?.font = UIFont.pingfangFont(type: .Regular, fontSize: 10)
        btn.titleLabel?.font = UIFont.thoughtImage(type: .Regular, fontSize: 10)
        //: btn.setImage(UIImage.outsideText(name: "icon_coinxxx"), for: .normal)
        btn.setImage(UIImage.outsideText(name: (String(str_arrayName) + str_giftData.replacingOccurrences(of: "model", with: "xx"))), for: .normal)
    ...
    lazy var numBgView: UIImageView = {
        ...
        let img = UIImageView()
        //: let imag = UIImage.outsideText(name: "icon_gift_num_bg")
        let imag = UIImage.outsideText(name: (String(str_scaleName)))
        //: let sizex = imag.size
        let sizex = imag.size
    ...
    lazy var numLb: UILabel = {
        ...
        lb.font = UIFont.thoughtImage(type: .Regular, fontSize: 9)
        //: return lb
        return lb
        //: }()
    }()
...
extension VideoViewCell {
    ...
    func contentTheoryTitle(checked: Bool) {
        ...
        if checked {
            ...
            bgView.layer.borderColor = UIColor.offt().cgColor
    ...
    private func applicationAnimation() {
    ...
    func localRequest(currenmodel: WithMeasurable, giftType: AtRepresentable) {
        //: model = currenmodel
        model = currenmodel
        //: giftIcon.setUrlImage(urlStr: model.imgPreview ?? "")
        giftIcon.recordFinish(urlStr: model.imgPreview ?? "")
        //: priceBtn.setTitle("\(model.price)", for: .normal)
        priceBtn.setTitle("\(model.price)", for: .normal)
        //: selectedImageView.setUrlImage(urlStr: model.cornerMark, placeImg: nil)
        selectedImageView.recordFinish(urlStr: model.cornerMark, placeImg: nil)
        ...
        let attributes = [NSAttributedString.Key.font: UIFont.thoughtImage(type: .Regular, fontSize: 11),
...
extension VideoViewCell {
    ...
    func attention() {
        ...
        bgView.backgroundColor = UIColor.targetColor()
