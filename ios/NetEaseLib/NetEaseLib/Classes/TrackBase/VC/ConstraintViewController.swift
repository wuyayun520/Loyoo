...
/*: "midfield_img" :*/
fileprivate let str_liveData:[Character] = ["m","i","d","f","i","e","l"]
fileprivate let str_toText:[Character] = ["d","_","i","m","g"]

/*: "tab" :*/
fileprivate let str_viewTitle:String = "areaab"

/*: "page" :*/
fileprivate let str_managerFillName:String = "pavideo"

/*: "uid" :*/
fileprivate let str_toEmptyReturnValue:String = "ubottom"

/*: "model" :*/
fileprivate let str_pushValue:String = "moerrorel"

/*: "DateViewCell" :*/
fileprivate let str_giftName:String = "image pop var doTalkin"
fileprivate let str_voiceValue:String = "tItemCelmake user left time white"
fileprivate let str_appContent:[Character] = ["l"]

/*: "There's no feed yet." :*/
fileprivate let str_managerContent:String = "equal title mainTher"
fileprivate let str_videoName:String = "no freturn target else table view"
...
class ConstraintViewController: UIViewController {
    ...
    lazy var mainTableView: UITableView = {
        ...
        table.contentInset = UIEdgeInsets(top: 0, left: 0, bottom: a_userTitle, right: 0)
        //: return table
        return table
...
extension ConstraintViewController {
    ...
    func filter() {
        ...
        var dict = [String: Any]()
        //: dict["tab"] = 1
        dict[(str_viewTitle.replacingOccurrences(of: "area", with: "t"))] = 1
        //: dict["page"] = pageIndex
        dict[(str_managerFillName.replacingOccurrences(of: "video", with: "ge"))] = pageIndex
        //: TalkingMomentRequestTool.req_MomentList(params: dict) { succeed, result, errorModel in
        RequestTool.makeCompletion(params: dict) { succeed, result, errorModel in
...
extension ConstraintViewController {
    ...
    @objc func notificationRecoverView(notification: NSNotification) {
        //: let userinfo = notification.userInfo as![String: AnyObject]
        let userinfo = notification.userInfo as! [String: AnyObject]
        //: let uid: String = userinfo["uid"] as! String
        let uid: String = userinfo[(str_toEmptyReturnValue.replacingOccurrences(of: "bottom", with: "id"))] as! String
    ...
    @objc func like(notification: NSNotification) {
        ...
        let model: CustomMeasurable = userinfo[(str_pushValue.replacingOccurrences(of: "error", with: "d"))] as! CustomMeasurable
        //: for i in 0..<self.dataSourceArr.count {
        for i in 0 ..< self.dataSourceArr.count {
    ...
    @objc func hideDoing(notification: NSNotification) {
        //: let userinfo = notification.userInfo as![String: AnyObject]
        let userinfo = notification.userInfo as! [String: AnyObject]
        //: let model: TalkingMomentModel = userinfo["model"] as! TalkingMomentModel
        let model: CustomMeasurable = userinfo[(str_pushValue.replacingOccurrences(of: "error", with: "d"))] as! CustomMeasurable
...
extension ConstraintViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let identifier = (String(str_giftName.suffix(6)) + "gMomen" + String(str_voiceValue.prefix(8)) + String(str_appContent))
        //: var cell = tableView.dequeueReusableCell(withIdentifier: identifier) as? TalkingMomentItemCell
        var cell = tableView.dequeueReusableCell(withIdentifier: identifier) as? DateViewCell
        //: if cell == nil {
        if cell == nil {
            //: cell = TalkingMomentItemCell(style: .default, reuseIdentifier: identifier)
            cell = DateViewCell(style: .default, reuseIdentifier: identifier)
        }
    ...
    func tableView(_: UITableView, willDisplay cell: UITableViewCell, forRowAt indexPath: IndexPath) {
        ...
        if self.dataSourceArr.count > indexPath.row {
            ...
            if indexPath.row == 0 && self.isfirstvideoCell == true {
                ...
                if model.momentType == CellSubqueryConvertible.Video.rawValue {
                    //: guard let tempcell: TalkingMomentItemCell = cell as? TalkingMomentItemCell  else {
                    guard let tempcell: DateViewCell = cell as? DateViewCell else {
                        //: return
                        return
                    }
                    //: tempcell.playVideo()
                    tempcell.equilateral()
                }
            }
        }
    }
...
extension ConstraintViewController: UIScrollViewDelegate {
    ...
    func group(scrollView: UIScrollView) {
        ...
        if let middleIndexPath = mainTableView.indexPathForRow(at: CGPoint(x: 0, y: scrollView.contentOffset.y + mainTableView.frame.size.height / 2)) {
            ...
            if dataSourceArr.count > middleIndexPath.row {
                ...
                let cell: DateViewCell = mainTableView.cellForRow(at: middleIndexPath) as! DateViewCell
...
// MARK: - CustomDateControllerDelegate
...
extension ConstraintViewController {
    ...
    private func dropSubviews() {
        ...
        style.TipsTitle = (String(str_managerContent.suffix(4)) + "e\'s " + String(str_videoName.prefix(4)) + "eed yet.").localized
        ...
        mainTableView.register(DateViewCell.self, forCellReuseIdentifier: (String(str_giftName.suffix(6)) + "gMomen" + String(str_voiceValue.prefix(8)) + String(str_appContent)))
    ...
    private func statusMagnitudeeraction() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(like(notification:)), name: a_conversationSenseName, object: nil)
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(notificationRecoverView(notification:)), name: a_screenData, object: nil)
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(hideDoing(notification:)), name: a_statusName, object: nil)
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(toCreate), name: a_tableName, object: nil)
    }
}
