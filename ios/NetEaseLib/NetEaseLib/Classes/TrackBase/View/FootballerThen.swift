...
fileprivate let str_matchValue:[UInt8] = [0x69,0x6e,0x69,0x74,0x28,0x63,0x6f,0x64,0x65,0x72,0x3a,0x29,0x20,0x68,0x61,0x73,0x20,0x6e,0x6f,0x74,0x20,0x62,0x65,0x65,0x6e,0x20,0x69,0x6d,0x70,0x6c,0x65,0x6d,0x65,0x6e,0x74,0x65,0x64]
...
class FootballerThen: UIView {
    var screenWithImageView: UIImageView?
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_matchValue, encoding: .utf8)!)
    }
...
extension FootballerThen {
    // 添加视图
    //: private func setupSubviews() {
    private func atChange() {
