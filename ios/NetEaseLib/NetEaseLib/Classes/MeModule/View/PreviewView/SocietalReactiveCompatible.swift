...
/*: "icon_male_default" :*/
fileprivate let str_arrayValue:[UInt8] = [0x69,0x63,0x6f,0x6e,0x5f,0x6d,0x61,0x6c,0x65,0x5f,0x64,0x65,0x66,0x61,0x75,0x6c,0x74]

/*: "icon_female_default" :*/
fileprivate let str_equalMakeContent:[Character] = ["i","c","o","n","_"]
fileprivate let str_normalStarName:[Character] = ["f","e","m","a","l","e","_","d","e","f","a","u","l","t"]

/*: "level_%@" :*/
fileprivate let str_hiddenContent:[Character] = ["l","e","v","e","l","_","%","@"]
...
class SocietalReactiveCompatible: UIView {
    ...
    lazy var headerPic = UIImageView().then {
        ...
        $0.image = UIImage.pineTreeStateSquare()
    ...
    lazy var nickLabel = UILabel().then {
        ...
        $0.font = .thoughtImage(type: .Medium, fontSize: 17)
        //: $0.textColor = .white
        $0.textColor = .white
    }
    ...
    lazy var ageLabel = UILabel().then {
        ...
        $0.font = .thoughtImage(type: .Regular, fontSize: 10)
        //: $0.textColor = .white
        $0.textColor = .white
    }
...
extension SocietalReactiveCompatible {
    ...
    func controlModel(model: EnableMeasurable) {
        //: headerPic.kf.setImage(with: URL(string: model.headPic), placeholder: UIImage.placeImgSquare())
        headerPic.kf.setImage(with: URL(string: model.headPic), placeholder: UIImage.pineTreeStateSquare())
        ...
        let imgStr = model.sex == SizeCustomReflectable.male.rawValue ? String(bytes: str_arrayValue, encoding: .utf8)! : (String(str_equalMakeContent) + String(str_normalStarName))
        //: sexImgView.image = UIImage(named: imgStr)
        sexImgView.image = UIImage(named: imgStr)
        //: let levelStr = String(format: "level_%@", model.level)
        let levelStr = String(format: (String(str_hiddenContent)), model.level)
