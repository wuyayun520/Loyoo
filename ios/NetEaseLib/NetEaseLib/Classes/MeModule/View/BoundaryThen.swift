...
fileprivate let str_haveData:[UInt8] = [0x64,0x65,0x74,0x6e,0x65,0x6d,0x65,0x6c,0x70,0x6d,0x69,0x20,0x6e,0x65,0x65,0x62,0x20,0x74,0x6f,0x6e,0x20,0x73,0x61,0x68,0x20,0x29,0x3a,0x72,0x65,0x64,0x6f,0x63,0x28,0x74,0x69,0x6e,0x69]

/*: "Edit Title" :*/
fileprivate let str_frameName:String = "resign var var sizeEdit "
fileprivate let str_shareValue:String = "text"

/*: "0/ :*/
fileprivate let str_arrayValue:[Character] = ["0","/"]

/*: "Finish" :*/
fileprivate let str_makeValue:[Character] = ["F","i","n","i","s","h"]

/*: "btn_delete" :*/
fileprivate let str_formalModelValue:String = "up succeed shadebtn_de"
fileprivate let str_shareAcceptValue:String = "lskiptskip"

/*: / :*/
fileprivate let str_pauseText:String = "/"
...
class BoundaryThen: UIView {
    ...
    override init(frame: CGRect) {
        ...
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(cellAdd))
    ...
    required init?(coder _: NSCoder) {
        ...
        fatalError(String(bytes: str_haveData.reversed(), encoding: .utf8)!)
    }
    ...
    lazy var titleLabel: UILabel = {
        ...
        lab.text = (String(str_frameName.suffix(5)) + "Titl" + str_shareValue.replacingOccurrences(of: "text", with: "e")).localized
    ...
    lazy var inputTView: NameHasDelegate = {
    ...
    private lazy var finishBtn: UIButton = {
        ...
        btn.setBackgroundImage(UIImage.stopAcross(colors: UIColor.doRange(), size: CGSize(width: 267, height: 50)), for: .normal)
    ...
    private lazy var closeBtn: UIButton = {
        ...
        btn.setImage(UIImage.outsideText(name: (String(str_formalModelValue.suffix(6)) + str_shareAcceptValue.replacingOccurrences(of: "skip", with: "e"))), for: .normal)
...
extension BoundaryThen: UITextViewDelegate {
    ...
    public func textViewDidChange(_ textView: UITextView) {
        ...
        if textView.text.count > lengthLimit {
            ...
            if textNum > lengthLimit && lengthLimit > 0 {
                ...
                textView.text = carteDuJour(index: lengthLimit, text: textContent)
            }
        }
    ...
    private func carteDuJour(index: Int, text: String) -> String {
        //: if text.count <= index {
        if text.count <= index {
            //: return text
            return text
